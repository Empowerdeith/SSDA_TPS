...
<div class="card text-black pt-5 pb-5 h-100" style="border-radius: 32px;">
    ...
    <p class="text-center">
        Este es el Sorteo Automático de test de drogas y alcohol, para utilizar este módulo debes escoger el porcentaje de sorteo y presionar realizar sorteo, luego escribir él o los correos de destino.
    </p>
    ...
    @if (isset($resultados)&& count($resultados)>0)
        ...
        <section class="d-lg-flex align-items-center justify-content-center pt-5 mb-5">
